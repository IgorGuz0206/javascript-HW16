...
function defUpperStr(abc) {
  return (abc || 'Default text').toUpperCase();
}
...
console.log(weekFn(4)); // 'Понедельник'
console.log(weekFn(5)); // 'Понедельник'
console.log(weekFn(6)); // 'Понедельник'
 ...
 *
 */
function mainFunc(a, b, cd) {
  if (cd && typeof cd === 'function') return cd(a, b);
  return false;
}
